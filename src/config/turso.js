...
console.log('Turso veritabanı bağlantı URL\'si kontrol ediliyor...');
...
console.log('Token var mı?', tursoAuthToken ? 'Evet' : 'Hayır');

// Bağlantı istemcisini oluştur
console.log('Turso bağlantısı oluşturuluyor...');

// Turso client yapılandırması
